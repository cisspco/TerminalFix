# TerminalFix Snapshot — 2026-09-04 UTC
...
- 페치 차단: malwarebytes.com, theregister.com, csoonline.com, rhisac.org, gbhackers.com, cyberpress.org, socprime.com
- seed: 0 / 신규 검증: 0 / 미검증: 0

## 캠페인 개요
TerminalFix는 ClickFix 소셜엔지니어링 기법의 변종으로, 피해자를 Windows Run 대화상자 대신 Windows Terminal/PowerShell로 유도해 더 복잡한 다단계 스크립트를 실행시킨다. 손상된 정상 웹사이트에 가짜 Cloudflare Turnstile CAPTCHA를 띄워 PowerShell 명령을 클립보드에 심고, 이를 붙여넣도록 유도한다. 이후 DLL 사이드로딩, PNG 스테가노그래피, 광범위한 AD 정찰, 그리고 커스텀 역방향 터널 임플란트를 통한 지속적 네트워크 레벨 프록시 접근으로 이어지는 다단계 침투 체인이다. 전날(2026-09-03) 대비 IOC 변동 없음 — Microsoft 원문(2026-08-28)을 재확인했으며 baseline과 완전히 일치함. 2차 보도(Malwarebytes, The Register, CSO Online, RH-ISAC, GBHackers, CyberPress, SOC Prime 등)는 검색 스니펫상 새로운 세부 내용이 없었고 이번 실행에서는 모두 페치 차단됨.
...
- 신규 보고서: 없음 — Microsoft 원문만 페치 성공(내용은 baseline과 동일), 2차 보도 7건(malwarebytes.com, theregister.com, csoonline.com, rhisac.org, gbhackers.com, cyberpress.org, socprime.com)은 모두 이번 실행에서 egress 프록시에 의해 차단됨
...
- [TerminalFix looks like ClickFix, but delivers a very different payload](https://www.malwarebytes.com/blog/news/2026/09/terminalfix-looks-like-clickfix-but-delivers-a-very-different-payload) — 2026-09 — blocked
- [Attack hides malware in PNGs and drops custom reverse tunnel on victims' machines](https://www.theregister.com/security/2026/08/31/attack-hides-malware-in-pngs-and-drops-custom-reverse-tunnel-on-victims-machines/) — 2026-08-31 — blocked
- [Fake Cloudflare CAPTCHA tricks victims into opening a tunnel for attackers](https://www.csoonline.com/article/4216927/fake-cloudflare-captcha-tricks-victims-into-opening-a-tunnel-for-attackers.html) — 2026-09 — blocked
- [TerminalFix Campaign Targets Multiple Critical Sectors with ClickFix Variant](https://rhisac.org/threat-intelligence/terminalfix-campaign-targets-multiple-critical-sectors-with-clickfix-variant/) — 2026-09 — blocked
- [TerminalFix Uses Fake CAPTCHA, DLL Sideloading and Steganography to Breach Networks](https://gbhackers.com/terminalfix-uses-fake-captcha/) — 2026-08/09 — blocked
...
- [TerminalFix Uses Reverse Tunnels for Persistent Access](https://socprime.com/active-threats/terminalfix-campaign-builds-reverse-tunnels-for-persistent-access/) — 2026-09 — blocked
